        ...
        <div class="bottom-and-footer">
            ...
            <section class="bottom-content" id="bottom-content">
                ...
                <div class="bottom-content-wrapper">
                    ...
                    <div class="main-card">
                        <article class="about-card" data-aos="flip-left" data-aos-delay="100">
                    ...
                    <div class="main-card">
                        <article class="projects-card" data-aos="flip-left" data-aos-delay="100">
                            <div class="overlay-card">
                                <a href="projects.php">
                                    <div class="overlay">
                                    </div>
                    ...
                    <div class="main-card">
                        <article class="blog-card" data-aos="flip-left" data-aos-delay="100">
                            <div class="overlay-card">
                                <a href="blog.php">
                                    <div class="overlay">
                                    </div>
                    ...
                    <div class="main-card">
                        <article class="contact-card" data-aos="flip-left" data-aos-delay="105">
                            <div class="overlay-card">
                                <a href="contact.php">
                                    <div class="overlay">
                                    </div>
